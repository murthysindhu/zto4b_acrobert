...
nevts = 10
#name = 'ZZTo2L4B-0j-t5gp'
name = 'ZJets_HT_800toInf_stock'
key = 'r0'
...
envs = [f'cd {CMSSW[i]}/src && eval `scram runtime -sh` && scram b -j8 && cd ../..' for i in range(len(CMSSW))]
